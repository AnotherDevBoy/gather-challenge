...
public class GameWebSocketApi extends WebSocketServer implements GameStateChangesObserver {
  ...
  public GameWebSocketApi(
    ...
    super(address);
    var allPlayers = playerPositionRepository.getPlayerPositions();
    this.gameState = new GameState(allPlayers);
    this.gameStateSyncer = new GameStateSyncer(this.gameState, playerPositionRepository, this);
